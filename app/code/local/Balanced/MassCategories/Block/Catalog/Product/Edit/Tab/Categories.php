 ...
 */
class Balanced_MassCategories_Block_Catalog_Product_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
...
//        $root = parent::getRoot();
        $root = $this->getRoot();
		/*
        if ($root && in_array($root->getId(), array())) {
