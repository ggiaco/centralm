 ...
 * File path:   app/code/local/Aitoc/Aitpermissions/Model/Sales/Quote/Observer.php
 * Copyright:   (c) 2013 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitpermissions')){ jTORragkEEjgyBZf('c23939b5073bbea19e7e96cd2cf6ece5'); ?><?php
class Aitoc_Aitpermissions_Model_Sales_Quote_Observer extends Mage_Core_Model_Abstract
{
