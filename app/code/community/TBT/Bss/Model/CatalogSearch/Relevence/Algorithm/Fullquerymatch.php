...
*/
class TBT_Bss_Model_CatalogSearch_Relevence_Algorithm_Fullquerymatch
		extends TBT_Bss_Model_CatalogSearch_Relevence_Algorithm_Productnamematch {
	
	public function appendRelevenceScore(
			TBT_Bss_Model_CatalogSearch_Mysql4_Fulltext_Collection &$search_query_collection, 
			&$rel_likes) {
